...
var cljs$core$async$impl$protocols$ReadPort$take_BANG_$dyn_42108 = (function (port,fn1_handler){
...
return cljs$core$async$impl$protocols$ReadPort$take_BANG_$dyn_42108(port,fn1_handler);
}
});
...
var cljs$core$async$impl$protocols$WritePort$put_BANG_$dyn_42118 = (function (port,val,fn1_handler){
var x__4428__auto__ = (((port == null))?null:port);
...
return cljs$core$async$impl$protocols$WritePort$put_BANG_$dyn_42118(port,val,fn1_handler);
}
});
...
var cljs$core$async$impl$protocols$Channel$close_BANG_$dyn_42121 = (function (chan){
...
return cljs$core$async$impl$protocols$Channel$close_BANG_$dyn_42121(chan);
}
});

var cljs$core$async$impl$protocols$Channel$closed_QMARK_$dyn_42125 = (function (chan){
var x__4428__auto__ = (((chan == null))?null:chan);
...
return cljs$core$async$impl$protocols$Channel$closed_QMARK_$dyn_42125(chan);
}
});
...
var cljs$core$async$impl$protocols$Handler$active_QMARK_$dyn_42129 = (function (h){
...
return cljs$core$async$impl$protocols$Handler$active_QMARK_$dyn_42129(h);
}
});

var cljs$core$async$impl$protocols$Handler$blockable_QMARK_$dyn_42135 = (function (h){
var x__4428__auto__ = (((h == null))?null:h);
...
return cljs$core$async$impl$protocols$Handler$blockable_QMARK_$dyn_42135(h);
}
});

var cljs$core$async$impl$protocols$Handler$commit$dyn_42137 = (function (h){
var x__4428__auto__ = (((h == null))?null:h);
...
return cljs$core$async$impl$protocols$Handler$commit$dyn_42137(h);
}
});
...
var cljs$core$async$impl$protocols$Buffer$full_QMARK_$dyn_42139 = (function (b){
...
return cljs$core$async$impl$protocols$Buffer$full_QMARK_$dyn_42139(b);
}
});

var cljs$core$async$impl$protocols$Buffer$remove_BANG_$dyn_42143 = (function (b){
var x__4428__auto__ = (((b == null))?null:b);
...
return cljs$core$async$impl$protocols$Buffer$remove_BANG_$dyn_42143(b);
}
});

var cljs$core$async$impl$protocols$Buffer$add_BANG__STAR_$dyn_42148 = (function (b,itm){
var x__4428__auto__ = (((b == null))?null:b);
...
return cljs$core$async$impl$protocols$Buffer$add_BANG__STAR_$dyn_42148(b,itm);
}
});

var cljs$core$async$impl$protocols$Buffer$close_buf_BANG_$dyn_42151 = (function (b){
var x__4428__auto__ = (((b == null))?null:b);
...
return cljs$core$async$impl$protocols$Buffer$close_buf_BANG_$dyn_42151(b);
}
});
