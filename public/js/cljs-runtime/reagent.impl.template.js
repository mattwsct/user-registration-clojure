...
var G__52075 = o;
goog.object.set(G__52075,reagent.impl.template.cached_prop_name(k),(reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1(v) : reagent.impl.template.convert_prop_value.call(null,v)));
...
return (function() { 
var G__52101__delegate = function (args){
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(x,args);
};
var G__52101 = function (var_args){
var args = null;
...
return G__52101__delegate.call(this,args);};
G__52101.cljs$lang$maxFixedArity = 0;
G__52101.cljs$lang$applyTo = (function (arglist__52105){
var args = cljs.core.seq(arglist__52105);
return G__52101__delegate(args);
});
G__52101.cljs$core$IFn$_invoke$arity$variadic = G__52101__delegate;
return G__52101;
})()
;
} else {
...
var G__52076 = o;
goog.object.set(G__52076,reagent.impl.template.cached_custom_prop_name(k),reagent.impl.template.convert_prop_value(v));
...
if(cljs.core.ifn_QMARK_(x)){
return (function() { 
var G__52115__delegate = function (args){
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(x,args);
};
var G__52115 = function (var_args){
var args = null;
if (arguments.length > 0) {
var G__52118__i = 0, G__52118__a = new Array(arguments.length -  0);
while (G__52118__i < G__52118__a.length) {G__52118__a[G__52118__i] = arguments[G__52118__i + 0]; ++G__52118__i;}
  args = new cljs.core.IndexedSeq(G__52118__a,0,null);
} 
return G__52115__delegate.call(this,args);};
G__52115.cljs$lang$maxFixedArity = 0;
G__52115.cljs$lang$applyTo = (function (arglist__52119){
var args = cljs.core.seq(arglist__52119);
return G__52115__delegate(args);
});
...
var G__52077 = props;
var G__52077__$1 = (((((!((id == null)))) && ((new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(props) == null))))?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__52077,new cljs.core.Keyword(null,"id","id",-1388402092),id):G__52077);
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__52077__$1,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$2(class$,(function (){var or__4126__auto__ = new cljs.core.Keyword(null,"class","class",-2030961996).cljs$core$IFn$_invoke$arity$1(props);
...
var props__$1 = reagent.impl.template.set_id_class((function (){var G__52078 = props;
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__52078,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$1(class$));
} else {
return G__52078;
}
})(),id_class);
...
var G__52079 = (cljs.core.count(argv) - first_child);
switch (G__52079) {
case (0):
...
var vec__52080 = cljs.core.next(cljs.core.re_matches(reagent.impl.template.re_tag,cljs.core.name(hiccup_tag)));
var tag = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__52080,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__52080,(1),null);
var className = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__52080,(2),null);
...
var temp__5808__auto___52140 = reagent.impl.util.react_key_from_vec(v);
if((temp__5808__auto___52140 == null)){
} else {
var key_52141 = temp__5808__auto___52140;
(jsprops.key = key_52141);
}
...
var temp__5808__auto___52145 = reagent.impl.util.react_key_from_vec(v);
if((temp__5808__auto___52145 == null)){
} else {
var key_52146 = temp__5808__auto___52145;
(jsprops.key = key_52146);
}
...
var temp__5808__auto___52150 = reagent.impl.util.react_key_from_vec(argv);
if((temp__5808__auto___52150 == null)){
} else {
var key_52151 = temp__5808__auto___52150;
(jsprops.key = key_52151);
}
...
var temp__5808__auto___52155 = reagent.impl.util.get_react_key(cljs.core.meta(argv));
if((temp__5808__auto___52155 == null)){
} else {
var key_52156 = temp__5808__auto___52155;
(jsprops.key = key_52156);
}
...
var temp__5808__auto___52157 = reagent.impl.util.get_react_key(cljs.core.meta(argv));
if((temp__5808__auto___52157 == null)){
} else {
var key_52158 = temp__5808__auto___52157;
(jsprops.key = key_52158);
}
...
return cljs.core.into_array.cljs$core$IFn$_invoke$arity$1(cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__52083_SHARP_){
return reagent.impl.protocols.as_element(compiler,p1__52083_SHARP_);
}),s));
});
...
var ctx = ({});
var vec__52084 = reagent.ratom.check_derefs((function (){
return reagent.impl.template.expand_seq_dev(x,ctx,compiler);
}));
var res = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__52084,(0),null);
var derefed = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__52084,(1),null);
...
break;
default:
var G__52187 = cljs.core.with_meta(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.cljs$core$IFn$_invoke$arity$3(n,(0),pos),cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(cljs.core.with_meta(v,null),(0),cljs.core.subs.cljs$core$IFn$_invoke$arity$2(n,(pos + (1))))], null),cljs.core.meta(v));
var G__52188 = compiler;
v = G__52187;
compiler = G__52188;
continue;
...
if((typeof reagent !== 'undefined') && (typeof reagent.impl !== 'undefined') && (typeof reagent.impl.template !== 'undefined') && (typeof reagent.impl.template.t_reagent$impl$template52090 !== 'undefined')){
} else {
...
*/
reagent.impl.template.t_reagent$impl$template52090 = (function (opts,id,fn_to_element,meta52091){
this.opts = opts;
this.id = id;
this.fn_to_element = fn_to_element;
this.meta52091 = meta52091;
this.cljs$lang$protocol_mask$partition0$ = 393216;
this.cljs$lang$protocol_mask$partition1$ = 0;
});
(reagent.impl.template.t_reagent$impl$template52090.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_52092,meta52091__$1){
var self__ = this;
var _52092__$1 = this;
return (new reagent.impl.template.t_reagent$impl$template52090(self__.opts,self__.id,self__.fn_to_element,meta52091__$1));
}));

(reagent.impl.template.t_reagent$impl$template52090.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_52092){
var self__ = this;
var _52092__$1 = this;
return self__.meta52091;
}));

(reagent.impl.template.t_reagent$impl$template52090.prototype.reagent$impl$protocols$Compiler$ = cljs.core.PROTOCOL_SENTINEL);

(reagent.impl.template.t_reagent$impl$template52090.prototype.reagent$impl$protocols$Compiler$get_id$arity$1 = (function (this$){
var self__ = this;
var this$__$1 = this;
return self__.id;
}));

(reagent.impl.template.t_reagent$impl$template52090.prototype.reagent$impl$protocols$Compiler$as_element$arity$2 = (function (this$,x){
var self__ = this;
var this$__$1 = this;
return reagent.impl.template.as_element(this$__$1,x,self__.fn_to_element);
}));

(reagent.impl.template.t_reagent$impl$template52090.prototype.reagent$impl$protocols$Compiler$make_element$arity$5 = (function (this$,argv,component,jsprops,first_child){
var self__ = this;
var this$__$1 = this;
return reagent.impl.template.make_element(this$__$1,argv,component,jsprops,first_child);
}));

(reagent.impl.template.t_reagent$impl$template52090.getBasis = (function (){
return new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Symbol(null,"opts","opts",1795607228,null),new cljs.core.Symbol(null,"id","id",252129435,null),new cljs.core.Symbol(null,"fn-to-element","fn-to-element",-1764467095,null),new cljs.core.Symbol(null,"meta52091","meta52091",535264460,null)], null);
}));

(reagent.impl.template.t_reagent$impl$template52090.cljs$lang$type = true);

(reagent.impl.template.t_reagent$impl$template52090.cljs$lang$ctorStr = "reagent.impl.template/t_reagent$impl$template52090");

(reagent.impl.template.t_reagent$impl$template52090.cljs$lang$ctorPrWriter = (function (this__4369__auto__,writer__4370__auto__,opt__4371__auto__){
return cljs.core._write(writer__4370__auto__,"reagent.impl.template/t_reagent$impl$template52090");
}));

/**
 * Positional factory function for reagent.impl.template/t_reagent$impl$template52090.
 */
reagent.impl.template.__GT_t_reagent$impl$template52090 = (function reagent$impl$template$create_compiler_$___GT_t_reagent$impl$template52090(opts__$1,id__$1,fn_to_element__$1,meta52091){
return (new reagent.impl.template.t_reagent$impl$template52090(opts__$1,id__$1,fn_to_element__$1,meta52091));
});

}

return (new reagent.impl.template.t_reagent$impl$template52090(opts,id,fn_to_element,cljs.core.PersistentArrayMap.EMPTY));
});
