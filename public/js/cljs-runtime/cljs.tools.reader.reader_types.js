...
var cljs$tools$reader$reader_types$Reader$read_char$dyn_41860 = (function (reader){
...
return cljs$tools$reader$reader_types$Reader$read_char$dyn_41860(reader);
}
});

var cljs$tools$reader$reader_types$Reader$peek_char$dyn_41865 = (function (reader){
var x__4428__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$Reader$peek_char$dyn_41865(reader);
}
});
...
var cljs$tools$reader$reader_types$IPushbackReader$unread$dyn_41873 = (function (reader,ch){
var x__4428__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IPushbackReader$unread$dyn_41873(reader,ch);
}
});
...
var cljs$tools$reader$reader_types$IndexingReader$get_line_number$dyn_41885 = (function (reader){
var x__4428__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_line_number$dyn_41885(reader);
}
});

var cljs$tools$reader$reader_types$IndexingReader$get_column_number$dyn_41896 = (function (reader){
var x__4428__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_column_number$dyn_41896(reader);
}
});

var cljs$tools$reader$reader_types$IndexingReader$get_file_name$dyn_41899 = (function (reader){
var x__4428__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_file_name$dyn_41899(reader);
}
});
...
var G__41992 = rdr.cljs$tools$reader$reader_types$Reader$read_char$arity$1(null);
var G__41993 = s.append(c);
c = G__41992;
s = G__41993;
continue;
}
